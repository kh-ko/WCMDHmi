...
#define ENABLE_SLOT_DSP_FOUND_DSP                 connect(DspSProvider::getInstance(), SIGNAL(signalEventFoundDsp(QString)                                    ), this, SLOT(onFoundDsp(QString)                                 ))
...
#define ENABLE_SLOT_LSETTING_CHANGED_ADC_CALIB_SETTING  connect(LocalSettingSProvider::getInstance(), SIGNAL(signalEventChangedADCAutoCalibSetting(ADCAutoCalibSettingDto)), this, SLOT(onChangedADCAutoCalibSetting(ADCAutoCalibSettingDto)))
